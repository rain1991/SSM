...
import com.rain.ssm.common.exceptions.BizException;


/**
 * className：TokenToolEncrypter <br>
 * Function： 一个Token加密与解密工具 ，不限于Token范围  只能解本JDK加密串。使用时，结合 TokenProductFactory 生成 平台Token
 * 通过解密，识别Token来源 <br>
...
public class TokenToolEncrypter  implements TokenBaseInter{
	...
	/* (non-Javadoc)
	 * @see com.clps.jfh.common.utils.token.TokenBaseInter#productToken(java.lang.String[])
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.clps.jfh.common.utils.token.TokenBaseInter#productToken(java.lang.String, java.lang.String)
	 */
	@Override
